...
export const posts = [
  ...
  },
  {
    ...
    title: "Give Your Soccer Team a Website Parents Actually Use",
    description:
      "Set up a soccer team website in five minutes — schedule with RSVPs, roster, photos, formations from the Coach's Playbook, and live scores — all behind a passcode, free for parents.",
    excerpt:
      "One link with the schedule, roster, photos, and Saturday's formation. No app downloads, no buried group texts, no fee for families.",
    tag: "Soccer",
    date: "2026-07-11",
    updated: "2026-07-11",
    readingTime: "5 min read",
    keywords: ["soccer team website", "youth soccer team website builder", "soccer team page for parents", "soccer team management site"],
    body: [
      { p: "Soccer season generates the same three questions on repeat: what time is the game, which field is it on, and where are the photos from Saturday? A group text answers each of them for about four hours before the answer scrolls away. A team website answers them all season from one link." },
      { h2: "What lives on a soccer team page" },
      { ul: [
        "The schedule with times, locations, and RSVPs — so you know who is coming to practice before you plan it.",
        "The roster, with player photos if you choose to add them.",
        "Full-quality photo galleries parents can actually download — no more group-text mush.",
        "Live scores on game day, and your record across the season.",
        "Game film from a YouTube or Vimeo link, and the formations you have drawn in the Coach's Playbook for players to study.",
      ]},
      { h2: "Passcode-protected, because these are kids" },
      { p: "A youth team's roster, faces, and field locations do not belong on the open internet. Your team page sits behind a passcode you control and share with your families — visible to the team, invisible to everyone else." },
      { h2: "No app, no accounts, no fee for families" },
      { p: "Parents open one link, type the passcode once, and they are in — on any phone, with nothing to install and no account to create. Grandparents included. On My-Team Sports, watching your own kid is always free for families; the coach runs the team for less than the cost of one pair of shin guards a season." },
      { h2: "Five minutes to set up" },
      { p: "Pick soccer, name your team, add the schedule, and share the link and passcode in your existing group chat — that is the whole migration. The next time someone asks which field, you answer with a link, and never answer again." },
    ],
    related: [
      ...
      { href: "/blog/soccer-lineup-formation-sheet", label: "Lineup & Formation Sheet", note: "Free printable with youth shapes" },
      { href: "/blog/ai-soccer-practice-planner", label: "AI Soccer Practice Planner", note: "A themed session in seconds" },
    ],
    faqs: [
      { q: "Do parents have to pay or create an account?", a: "No. Families open the team page with a link and passcode — no account, no app download, and it is always free for parents on My-Team Sports." },
      { q: "Is the team website private?", a: "Yes. The page is protected by a passcode you control, so the roster, photos, and field locations are visible only to your team's families." },
      { q: "Can I put game film on the team site?", a: "Yes — link film from YouTube or Vimeo and it appears on the team page, next to the schedule, scores, and photos." },
    ],
  },
  {
    slug: "baseball-team-website",
    title: "A Baseball Team Website with the Schedule, Stats, and Live Scores",
    description:
      "Build a youth baseball team website in minutes — schedule with RSVPs, roster, photo galleries, season stats from pitch-by-pitch scoring, and live game updates, behind a passcode.",
    excerpt:
      "The schedule, the stats, Saturday's photos, and the live score of tonight's game — one passcode-protected link for every family.",
    tag: "Baseball",
    date: "2026-07-11",
    updated: "2026-07-11",
    readingTime: "5 min read",
    keywords: ["baseball team website", "youth baseball team website builder", "little league team page", "baseball team site with stats"],
    body: [
      { p: "Baseball teams generate more information than any other youth sport: long schedules, reschedules after every storm, stats families genuinely care about, and a full season of photos. That is too much for a group text to carry. It is exactly what a team website is for." },
      { h2: "Built around what baseball families check" },
      { ul: [
        "The schedule — with RSVPs, so you know Tuesday whether you have nine for Saturday.",
        "Live scores on game night, updated pitch by pitch by your scorekeeper.",
        "Season stats that build automatically from scored games — batting lines without a spreadsheet.",
        "The roster, photo galleries in full quality, and game film from a YouTube or Vimeo link.",
        "Your win-loss record, updated the moment you post a final.",
      ]},
      { h2: "The stats sell it to the kids" },
      { p: "When games are scored play by play, every player builds a real stat line over the season. Kids check their batting average the way adults check the weather — and the team page is where they find it, next to the photos from the game where they got that double." },
      { h2: "Private by default" },
      { p: "Rosters, kids' photos, and field locations stay behind a passcode you control. Families get in with one link and the code; the open internet does not." },
      { h2: "Free for every family" },
      { p: "No app to download, no accounts to create, and no fee for parents — grandparents three states away follow the live score with the same link. Set up your team on My-Team Sports in about five minutes, and let the season run through one page instead of a hundred texts." },
    ],
    related: [
      { href: "/blog/baseball-scorekeeping-app", label: "Baseball Scorekeeping App", note: "Pitch-by-pitch, live for families" },
      { href: "/blog/ai-baseball-practice-plan-generator", label: "AI Baseball Practice Plans", note: "Stations plans and a lineup advisor" },
      { href: "/blog/share-team-schedule-and-photos-without-an-app", label: "Share Schedule & Photos", note: "Why one link beats the group text" },
    ],
    faqs: [
      { q: "Can the team website show live baseball scores?", a: "Yes. When your scorekeeper scores the game on their phone, the score, inning, and key plays update the team page in real time." },
      { q: "Where do the season stats come from?", a: "From your scored games — pitch-by-pitch scorekeeping builds each player's batting stats automatically across the season, no spreadsheet required." },
      { q: "Is a baseball team website safe for kids' information?", a: "The page is passcode-protected, so the roster, photos, and locations are visible only to the families you share the code with." },
    ],
  },
  {
    slug: "basketball-team-website",
    title: "A Basketball Team Website Every Family Can Open",
    description:
      "Give your basketball team one home — schedule with RSVPs, roster, live scoreboard, photos, and saved plays — behind a passcode, with no app for parents to download.",
    excerpt:
      "Game times, gym addresses, the live scoreboard, and the photos from Saturday — one link that works on every phone in the family.",
    tag: "Basketball",
    date: "2026-07-11",
    updated: "2026-07-11",
    readingTime: "4 min read",
    keywords: ["basketball team website", "youth basketball team page", "basketball team website builder", "team website for parents"],
    body: [
      { p: "Basketball's information problem is the gym. Games move between schools and rec centers all season, half of them with confusing entrances, and the 'which gym is it this week?' text is a winter tradition. Put the schedule — with locations — on one page every family can open, and retire the tradition." },
      { h2: "One page, the whole season" },
      { ul: [
        "The schedule with times, gym locations, and RSVPs for practices and games.",
        "The live scoreboard on game day — score, quarter, and clock for everyone who could not fit in the bleachers.",
        "The roster, full-quality photo galleries, and game film from a YouTube or Vimeo link.",
        "Plays you have marked visible in the Coach's Playbook, so kids can study the sets between practices.",
        "Your record, updated when you post each final.",
      ]},
      { h2: "Works on every phone in the family" },
      { p: "The team page is a website, not an app: one link, one passcode, nothing to install, no accounts. The parent with the ancient Android, the grandparent with the iPad, and the kid with the school Chromebook all see the same page." },
      { h2: "Private to your team" },
      { p: "Everything sits behind a passcode you control. Kids' names, faces, and gym locations stay with your families — not on the open internet." },
      { h2: "Set it up before the next game" },
      { p: "Create your team on My-Team Sports, add the schedule, share the link and passcode once in the group chat, and post the next 'which gym?' answer as a link to the page. Parents are always free, and the whole team runs from the same place you plan practices and design plays." },
    ],
    related: [
      { href: "/blog/basketball-live-scoreboard-app", label: "Live Basketball Scoreboard", note: "In every parent's pocket" },
      { href: "/blog/basketball-play-designer", label: "Basketball Play Designer", note: "Diagram plays on a digital court" },
      { href: "/blog/basketball-rotation-chart", label: "Basketball Rotation Chart", note: "Fair minutes, planned ahead" },
    ],
    faqs: [
      { q: "Do families need to download an app?", a: "No. The team page is a website — one link and a passcode on any phone, tablet, or computer, with no accounts and no fee for parents." },
      { q: "Can parents who miss the game follow it live?", a: "Yes. The live scoreboard updates the team page in real time with the score, quarter, and clock, and the final lands next to the season record." },
      { q: "Can players see plays on the team site?", a: "Yes — plays you mark visible in the Coach's Playbook appear on the team site, so kids can review sets between practices." },
    ],
  },
  {
