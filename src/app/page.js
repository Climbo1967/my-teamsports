...
const FEATURES = [
  ...
  { icon: "💬", title: "Message Board", desc: "Announcements that stay informational, uplifting, and positive. Pin the important stuff. Notify your whole team by email and phone alert in one click. No group-text chaos." },
  { icon: "🔔", title: "Game-Day Alerts", desc: "Parents tap once to get push notifications for announcements and game updates, right on their phone. No app store, no account, and free for everyone." },
